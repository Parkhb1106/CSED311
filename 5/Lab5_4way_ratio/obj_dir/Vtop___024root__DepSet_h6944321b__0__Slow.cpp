...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__cpu__DOT__cache__DOT__which_set = VL_RAND_RESET_I(2);
    vlSelf->top__DOT__cpu__DOT__cache__DOT__which_set_hit = VL_RAND_RESET_I(2);
    vlSelf->top__DOT__cpu__DOT__cache__DOT__which_set_evict = VL_RAND_RESET_I(2);
