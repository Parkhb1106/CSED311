...
void Valu___024root__trace_chg_0_sub_0(Valu___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->chgSData(oldp+0,(vlSelfRef.A),16);
    bufp->chgSData(oldp+1,(vlSelfRef.B),16);
    bufp->chgCData(oldp+2,(vlSelfRef.FuncCode),4);
    bufp->chgSData(oldp+3,(vlSelfRef.C),16);
    bufp->chgBit(oldp+4,(vlSelfRef.OverflowFlag));
    bufp->chgIData(oldp+5,(vlSelfRef.ALU__DOT__OF),17);
}
