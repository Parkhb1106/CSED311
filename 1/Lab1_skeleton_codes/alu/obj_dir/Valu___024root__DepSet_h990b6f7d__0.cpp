...
VL_INLINE_OPT void Valu___024root___ico_sequent__TOP__0(Valu___024root* vlSelf) {
    ...
    // Body
    vlSelfRef.C = 0U;
    vlSelfRef.OverflowFlag = 0U;
    vlSelfRef.ALU__DOT__OF = 0U;
    if ((8U & (IData)(vlSelfRef.FuncCode))) {
        vlSelfRef.C = (0xffffU & ((4U & (IData)(vlSelfRef.FuncCode))
                                   ? ((2U & (IData)(vlSelfRef.FuncCode))
                                       ? ((1U & (IData)(vlSelfRef.FuncCode))
                                           ? 0U : ((IData)(1U) 
                                                   + 
                                                   (~ (IData)(vlSelfRef.A))))
                                       : ((1U & (IData)(vlSelfRef.FuncCode))
                                   ...
                                   : ((2U & (IData)(vlSelfRef.FuncCode))
                                       ...
                                       : ((1U & (IData)(vlSelfRef.FuncCode))
                                           ...
                                           : ((IData)(vlSelfRef.A) 
                                              ^ (IData)(vlSelfRef.B))))));
    } else if ((4U & (IData)(vlSelfRef.FuncCode))) {
        vlSelfRef.C = (0xffffU & ((2U & (IData)(vlSelfRef.FuncCode))
                                   ? ((1U & (IData)(vlSelfRef.FuncCode))
                                       ? (~ ((IData)(vlSelfRef.A) 
                                             | (IData)(vlSelfRef.B)))
                                       : (~ ((IData)(vlSelfRef.A) 
                                   ...
                                   : ((1U & (IData)(vlSelfRef.FuncCode))
                                       ...
                                       : ((IData)(vlSelfRef.A) 
                                          & (IData)(vlSelfRef.B)))));
    } else if ((2U & (IData)(vlSelfRef.FuncCode))) {
        vlSelfRef.C = (0xffffU & ((1U & (IData)(vlSelfRef.FuncCode))
                                   ? (~ (IData)(vlSelfRef.A))
                                   : (IData)(vlSelfRef.A)));
    } else if ((1U & (IData)(vlSelfRef.FuncCode))) {
        vlSelfRef.ALU__DOT__OF = (0x1ffffU & (((0x10000U 
                                                & ((IData)(vlSelfRef.A) 
                                                   << 1U)) 
                                               | (IData)(vlSelfRef.A)) 
                                              - ((0x10000U 
                                                  & ((IData)(vlSelfRef.B) 
                                                     << 1U)) 
                                                 | (IData)(vlSelfRef.B))));
        vlSelfRef.C = (0xffffU & vlSelfRef.ALU__DOT__OF);
        vlSelfRef.OverflowFlag = (1U & VL_REDXOR_32(
                                                    (0x18000U 
                                                     & vlSelfRef.ALU__DOT__OF)));
    } else {
        vlSelfRef.ALU__DOT__OF = (0x1ffffU & (((0x10000U 
                                                & ((IData)(vlSelfRef.A) 
                                                   << 1U)) 
...
void Valu___024root___eval_debug_assertions(Valu___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    if (VL_UNLIKELY((vlSelfRef.FuncCode & 0xf0U))) {
