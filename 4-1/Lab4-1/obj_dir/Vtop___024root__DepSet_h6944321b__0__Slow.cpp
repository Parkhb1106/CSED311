...
VL_ATTR_COLD void Vtop___024root___eval_initial(Vtop___024root* vlSelf) {
    ...
    vlSelfRef.__Vtrigprevexpr___TOP__top__DOT__cpu__DOT__clk_and_ishalted__0 
...
VL_ATTR_COLD void Vtop___024root___stl_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    if (vlSelfRef.top__DOT__cpu__DOT__pc_src1) {
        ...
        vlSelfRef.top__DOT__cpu__DOT__mux_pcsrc2__DOT__out 
            = vlSelfRef.top__DOT__cpu__DOT__mux_pcsrc2_result;
        vlSelfRef.top__DOT__cpu__DOT__next_pc = vlSelfRef.top__DOT__cpu__DOT__EX_MEM_pc_add_imm;
    } else {
        ...
        vlSelfRef.top__DOT__cpu__DOT__mux_pcsrc2__DOT__out 
            = vlSelfRef.top__DOT__cpu__DOT__mux_pcsrc2_result;
        vlSelfRef.top__DOT__cpu__DOT__next_pc = vlSelfRef.top__DOT__cpu__DOT__mux_pcsrc2_result;
    }
...
VL_ATTR_COLD void Vtop___024root___dump_triggers__act(Vtop___024root* vlSelf) {
    ...
    if ((1ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 0 is active: @(posedge top.cpu.clk_and_ishalted)\n");
    }
    if ((2ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 1 is active: @([changed] top.cpu.clk_and_ishalted)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vtop___024root___dump_triggers__nba(Vtop___024root* vlSelf) {
    ...
    if ((1ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 0 is active: @(posedge top.cpu.clk_and_ishalted)\n");
    }
    if ((2ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 1 is active: @([changed] top.cpu.clk_and_ishalted)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__cpu__DOT__clk_and_ishalted = VL_RAND_RESET_I(1);
    ...
    vlSelf->__Vtrigprevexpr___TOP__top__DOT__cpu__DOT__clk_and_ishalted__0 = VL_RAND_RESET_I(1);
